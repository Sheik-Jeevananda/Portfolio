...
export const PROJECTS: Project[] = [
  {
    ...
    title: "DevConnect",
    description:
      "A full-stack social platform for developers. Real-time chat, project collaboration, and a live code editor. Built with MERN stack and Socket.io.",
  ...
  },
  {
    ...
    title: "ShopNest",
    description:
      "Modern e-commerce with Next.js. Cart, Stripe payments, product filters, admin dashboard, and order tracking.",
  ...
  },
  {
    ...
    title: "TaskFlow",
    description:
      "Kanban-style project management app with drag-and-drop, team collaboration, and beautiful analytics dashboard.",
    tags: ["React", "Express", "MySQL", "Chart.js"],
    gradientFrom: "from-emerald-500",
    gradientTo: "to-teal-600",
    emoji: "📋",
    status: "Coming Soon",
    githubUrl: "https://github.com/Sheik-Jeevananda",
    liveUrl: "#",
  },
  {
    id: 4,
    title: "BlogForge",
    description:
      "Feature-rich blogging platform with markdown editor, SEO optimization, tag search, comments, and JWT auth.",
    tags: ["Next.js", "MongoDB", "Tailwind", "JWT"],
